 ...
 */
 ...
 function orderArray($array,$order){
    ...
    if($order == 'Asc'){
        return $orderedArray = array_merge(orderArray($minorsArray,$order),[$pivot],orderArray($highersArray,$order));
    }else{
        return $orderedArray = array_merge(orderArray($highersArray,$order),[$pivot],orderArray($minorsArray,$order));
    }
 }
