...
public class Challenge06{
	public static void main (String[] args) {
		...
		textIn=JOptionPane.showInputDialog("Indique el texto que desee invertir");
				
		char[] choppedText=textIn.toCharArray();
		char[] invertedText= new char[choppedText.length];
		
		for (int i = 0; i < choppedText.length; i++) {
			invertedText[i]=choppedText[(choppedText.length-1)-i];
		}
		System.out.println(String.valueOf(invertedText));
	}
}