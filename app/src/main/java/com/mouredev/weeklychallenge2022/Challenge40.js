...
function PrintTriangle(triangle) {
    ...
    console.log(`Pascal Triangle. Side => ${n}`);
    console.log(string);
}
...
PrintTriangle(PascalTriangle(0));
PrintTriangle(PascalTriangle(1));
PrintTriangle(PascalTriangle(2));
PrintTriangle(PascalTriangle(3));
PrintTriangle(PascalTriangle(4));
PrintTriangle(PascalTriangle(5));
PrintTriangle(PascalTriangle(6));
