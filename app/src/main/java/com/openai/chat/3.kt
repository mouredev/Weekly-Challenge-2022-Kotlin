 ...
 * Resuelto: Sí.
 * Iteracciones: 1
 * Explicación: La función toma un entero como parámetro y devuelve un valor booleano indicando si el número es primo o no. Dentro de la función, primero se comprueba si el número es menor o igual a 1,
