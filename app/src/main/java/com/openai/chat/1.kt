 ...
 * Resuelto: No.
 * Explicación:
 * · Una forma de resolver este problema en Kotlin sería utilizar dos diccionarios (mapas) para contar la cantidad de veces que cada letra aparece en cada una de las
