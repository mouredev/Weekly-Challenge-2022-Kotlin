 ...
 *
 * Resuelto: Sí. En 2 iteraciones.
 * Explicación:
 * · El código utiliza un bucle for para recorrer los números del 1 al 100. Para cada número, se utiliza una estructura when para comprobar si es múltiplo de 3 y de 5, de 3 o de 5,
 ...
 * + Si quieres que se muestren los números sustituidos en distintas líneas, puedes añadir un salto de línea después de cada impresión utilizando la función println() en lugar de print().
 *
 */
