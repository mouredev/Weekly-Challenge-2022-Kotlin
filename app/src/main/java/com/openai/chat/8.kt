 ...
 * Resuelto: Sí.
 * Iteracciones: 2
 * Explicación: Este programa toma un número entero como entrada y devuelve su representación en binario como una cadena de caracteres. Para transformar el número, el programa utiliza un bucle while
